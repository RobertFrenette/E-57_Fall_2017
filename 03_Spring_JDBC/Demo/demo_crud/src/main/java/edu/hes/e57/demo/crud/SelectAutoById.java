 ...
 * by Auto Id.  
 */
public class SelectAutoById extends MappingSqlQuery<Auto> {
    private static final String SQL_SELECT_AUTO_BY_ID = 
            "select id, manufacturer_id, model, year, msrp from auto where id = :id";

    public SelectAutoById(DataSource dataSource) {
        super(dataSource, SQL_SELECT_AUTO_BY_ID);
