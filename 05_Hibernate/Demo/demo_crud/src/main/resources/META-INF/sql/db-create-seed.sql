DROP DATABASE HibernateAutosDB;
CREATE DATABASE HibernateAutosDB;
USE HibernateAutosDB;
...
CREATE TABLE DRIVETRAIN_AUTO (
  ...
  ,CONSTRAINT PK_DRIVETRAIN_AUTO PRIMARY KEY (DRIVETRAIN_ID, AUTO_ID)
  , CONSTRAINT FK_DRIVETRAIN_AUTO_1
      FOREIGN KEY (DRIVETRAIN_ID)REFERENCES DRIVETRAIN(ID) 
  , CONSTRAINT FK_DRIVETRAIN_AUTO_2
